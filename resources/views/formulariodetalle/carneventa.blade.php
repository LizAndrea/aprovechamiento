...
<div class="card-panel">
    ...
    <h5 class="header2 center-align"><strong>FOMULARIO DE REPORTE (RESTAURANTES): VENTA DE CARNE DE LAGARTO <i>(Caiman yacare)</i></strong></h5>
    <ul>
...
<table class="table table-bordered table-striped table-hover highlight" id="tableData">
    <thead>
        <tr>
            <th>FECHA</th>
            <th>TIPO DE PLATO COMERCIALIZADO</th>
    ...
    @foreach($formularioDetalle as $item)
        <tr class="optionableForm" data-href='#' data-id='{{$item->id}}' id='tr{{$item->id}}' >
            ...
            <td class="hide">
            	...
            	<a class="ajaxEditableCV btn blue" href="#" data-id="{{$item->id}}"><i class="material-icons">mode_edit</i></a>
           	</td>
        </tr>
    @endforeach
    </tbody>
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    .click(function(){
        ...
        $('#btnUpdateCV').addClass('hide');
        $('#btnSaveCV').removeClass('hide');
    })
    .leanModal({
 ...
 <div id="modal1" class="modal modal-fixed-footer">
    <div class="modal-content">
      @include('formulariodetalle.carneventacreate')
    </div>
