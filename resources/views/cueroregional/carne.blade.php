...
<div class="card-panel">
    <h5 class="header2"><strong>FOMULARIO: COMPRA - VENTA CARNE DE LAGARTO <i>(Caiman yacare)</i></strong></h5>
    {!! Form::open(['route' => 'formulario.store', 'class' => 'form-horizontal']) !!}
    {!! Form::hidden('TipoFormulario','C') !!}
    <div class="row">
    ...
    <div class="row">
        <div class="input-field right-align col s12 m12">
          {!! Form::button('<i class="material-icons right  triggerButton">done</i>Guardar', ['class' => 'btn formButton','type'=>'submit']) !!}
            <a href="{{route('formulario.index')}}" class="btn formButton"><i class="material-icons right">clear</i>Cancelar</a>
        </div>
    </div>
    {!! Form::close() !!}
</div>
