...
class CueroRegionalComunidad extends Model
{
     ...
     * @var string
     */
    protected $table = 'CueroRegionalComunidad';
     ...
     * @var array
     */
    protected $fillable = ['version', 'Num', 'CueroRegional', 'Provincia', 'Municipio', 'Comunidad', 'Representante', 'Telefono', 'NumeroCazadores', 'Observaciones', 'UsuarioRegistro', 
