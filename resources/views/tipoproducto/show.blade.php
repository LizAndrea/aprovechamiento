...
<div class="card-panel">
    <div class="row">
        <div class="col s2 m2 l2">
            <h6><strong>TIPO PRODUCTO</strong></h6>
        </div>
        <div class=" col s10 m10 l10 right-align"> 
                <a href="{{url('tipoproducto')}}" class="btn right-align toolBarButton tooltipped" data-tooltip="{{trans('labels.back')}}"><i class="material-icons right">undo</i></a>
                <a href="{{ route('tipoproducto.edit', $item->id) }}" class="btn right-align toolBarButton tooltipped" data-tooltip="{{trans('labels.edit')}}"><i class="material-icons right">mode_edit</i></a>
                {!! Form::open(['method'=>'DELETE', 'route' => ['tipoproducto.destroy', $item->id], 'style' => 'display:inline' ]) !!}
    ...
    <div class="row">
      <div class="col s12 m12">
        <ul class="collection with-header">
            ...
            <li class="collection-item"><strong>Tipo Producto: </strong> {{$item->TipoProducto}}</li>
