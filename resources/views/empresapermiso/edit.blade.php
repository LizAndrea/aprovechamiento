...
<div class="card-panel">
    <h6 class="header2"><strong>REGISTRO</strong></h6>
    {!! Form::model($empresaPermiso, [
        'method' => 'PATCH',
        'route' => ['empresapermiso.update', $empresaPermiso->id],
   ...
   <div class="row">
    ...
    <div class="row">
        <div class="input-field col s12 m3 l3">
            {!! Form::checkbox('Vigente', '1', $empresaPermiso->Vigente , ['id'=>'Vigente']) !!}
    ...
    <div class="row">
        <div class="input-field right-align col s12 m12">
          {!! Form::button('<i class="material-icons right  triggerButton">done</i>Guardar', ['class' => 'btn formButton','type'=>'submit']) !!}
            <a href="{{route('listEmpresaPermiso',$empresaPermiso->Empresa)}}" class="btn formButton"><i class="material-icons right">clear</i>Cancelar</a>
        </div>
    </div>
    {!! Form::close() !!}
</div>
