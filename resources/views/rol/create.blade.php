...
<div class="card-panel">
    ...
    {!! Form::open(['route' => 'rol.store', 'class' => 'form-horizontal']) !!}
    <div class="row">
    ...
    <div class="row">
        <div class="input-field col s6 m6 l6">
          {!! Form::checkbox('Parametros', '1',false, ['id'=>'Parametros']) !!}
          {!! Form::label('Parametros', 'Administra Parámetros ') !!}
        </div>
    </div>
    <div class="row">
        <div class="input-field col s6 m6 l6">
          {!! Form::checkbox('Empresas', '1',false, ['id'=>'Empresas']) !!}
          {!! Form::label('Empresas', 'Administra Empresas ') !!}
        </div>
    </div>
    <div class="row">
        <div class="input-field col s6 m6 l6">
          {!! Form::checkbox('Usuarios', '1',false, ['id'=>'Usuarios']) !!}
          {!! Form::label('Usuarios', 'Administra Usuarios ') !!}
        </div>
    </div>
        <div class="row">
        <div class="input-field col s6 m6 l6">
          {!! Form::checkbox('Formularios', '1',false, ['id'=>'Formularios']) !!}
          {!! Form::label('Formularios', 'Administra Formularios ') !!}
        </div>
    </div>
        <div class="row">
        <div class="input-field col s6 m6 l6">
          {!! Form::checkbox('Reportes', '1',false, ['id'=>'Reportes']) !!}
          {!! Form::label('Reportes', 'Administra Reportes ') !!}
        </div>
    </div>
    <div class="row">
        <div class="input-field col s6 m6 l6">
          {!! Form::checkbox('SoloEmpresa', '1',false, ['id'=>'SoloEmpresa']) !!}
