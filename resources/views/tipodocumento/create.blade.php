...
<div class="card-panel">
    ...
    {!! Form::open(['route' => 'tipodocumento.store', 'class' => 'form-horizontal','files'=>true]) !!}
    <div class="row">
    ...
    <div class="row">
        <div class="input-field col s6 m6 l6">
          {!! Form::checkbox('Obligatorio', '1',false, ['id'=>'Obligatorio']) !!}
          {!! Form::label('Obligatorio', 'Obligatorio ') !!}
        </div>
    <div class="input-field col s6 m6 l6">
          {!! Form::checkbox('PublicadoWeb', '1',false, ['id'=>'PublicadoWeb']) !!}
